...
test_that("mapper(): Basic tracts-only area call works w/ mapDF",{
  expect_s3_class(mapper(mapDF=data,
                         tableID=NULL,
                         variable=NULL,
                         variableSummary=NULL,
...
test_that("mapper(): Basic tracts-only radius call works w/ mapDF",{
  expect_s3_class(mapper(mapDF=data,
                         tableID=NULL,
                         variable=NULL,
                         variableSummary=NULL,
...
test_that("mapper(): Basic tracts-only area call works in interactive w/ mapDF",{
  expect_s3_class(mapper(mapDF=data,
                         tableID=NULL,
                         variable=NULL,
                         variableSummary=NULL,
